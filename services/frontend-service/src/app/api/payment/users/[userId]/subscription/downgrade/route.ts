...
export async function POST(
  ...
  try {
    ...
    // In production, this would schedule a downgrade at period end via Stripe/payment service
    const updatedSubscription = {
      ...currentSubscription,
      // For downgrades, we typically schedule the change for the end of the current period
      pending_plan_id: new_plan_id,
      pending_plan_name: newPlan.name,
      pending_price: newPlan.price,
      pending_period: newPlan.period,
      will_downgrade_at_period_end: true,
